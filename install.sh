...
sudo apt-get install  -y  git python3-pip python-is-python3 cmake gcc g++ libopencv-dev build-essential libglib2.0-dev libeigenev net-tools libgl1-mesa-dev libegl1-mesa-dev libglew-dev
mkdir ~/tools/
cd ~/tools/
